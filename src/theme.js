	...
	theme: {
	  ...
	  extend: {
		...
		spacing: {
			...
			'5xl': 		'var(--ft-space-5xl)',
			'6xl': 		'var(--ft-space-6xl)',
			'7xl': 		'var(--ft-space-7xl)',
			'8xl': 		'var(--ft-space-8xl)',
			'jumbotron': 	'var(--ft-space-jumbotron)',
			'4xs-3xs': 		'var(--ft-space-4xs-3xs)',
			'3xs-2xs': 		'var(--ft-space-3xs-2xs)',
			'2xs-xs': 		'var(--ft-space-2xs-xs)',
			'xs-sm':  		'var(--ft-space-xs-sm)',
			'sm-md':  		'var(--ft-space-sm-md)',
			'md-lg':  		'var(--ft-space-md-lg)',
			'lg-xl':  		'var(--ft-space-lg-xl)',
			'xl-2xl':  		'var(--ft-space-xl-2xl)',
			'2xl-3xl': 		'var(--ft-space-2xl-3xl)',
			'3xl-4xl': 		'var(--ft-space-3xl-4xl)',
			'4xl-5xl': 		'var(--ft-space-4xl-5xl)',
			'5xl-6xl': 		'var(--ft-space-5xl-6xl)',
			'6xl-7xl': 		'var(--ft-space-6xl-7xl)',
			'7xl-8xl': 		'var(--ft-space-7xl-8xl)',
			'112':	'28rem',
			'128':	'32rem',
			'144':	'36rem',
			'160':	'40rem',
		...
		borderRadius: {
			...
			'card':   'var(--ft-rounded-card)',
			'button': 'var(--ft-rounded-button)',
		},
		borderWidth: {
			'3': 		'3px',
			'5': 		'5px',
			...
			'card':     'var(--ft-border-card)',
			'button':   'var(--ft-border-button)',
		},
		colors: {
			primary: {
			  50: "#FFFAF2",
